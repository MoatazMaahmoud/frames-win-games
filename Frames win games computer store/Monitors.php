...
<head>
  ...
  *{
     ...
     .product:hover {
      ...
      /* IMAGES */
      #image-1 {background-image: url("https://m.media-amazon.com/images/I/61neyqvKCbL._AC_SL1001_.jpg"); background-size:250px;}
      
      #image-2 {background-image: url("https://m.media-amazon.com/images/I/61HQ0foFMkL._AC_SL1200_.jpg"); background-size: 250px;}
      
      #image-3 {background-image: url("https://m.media-amazon.com/images/I/81pXXv2O9LL.__AC_SY300_SX300_QL70_ML2_.jpg"); background-size: 250px;}
      
      #image-4 {background-image: url("https://m.media-amazon.com/images/I/7195sXyWTbL._AC_SL1500_.jpg"); background-size: 250px;}
 ...
 ?>
    ...
    <div class="listing-section">
        ...
        <div class="product">
          ...
          <a href="BenQ-view.php"> <button type="button" name="item-1-view"   id="item-1-view">View</button> </a>
          </div>
        </div>
        <!--End product-->
        ...
        <div class="product">
          ...
          <div class="text-box">
            <h2 class="item">Xiaomi Mi Desktop Full HD Monitor </h2> 
            <h3 class="price">3,680 EGP</h3> 
        ...
        <div class="product">
          ...
          <div class="text-box">
            <h2 class="item">DELL 27 Monitor S2721HN</h2>
            <h3 class="price">5,650 EGP</h3>
        ...
        <div class="product">
          ...
          <div class="text-box">
            <h2 class="item">ASUS VA24EHE 24" 23.8"</h2>
            <h3 class="price">3,747 EGP</h3>
