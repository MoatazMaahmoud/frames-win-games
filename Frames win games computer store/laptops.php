...
<head>
  ...
  *{
     ...
     .product:hover {
      ...
      /* IMAGES */
      #image-1 {background-image: url("https://m.media-amazon.com/images/I/41pgEjCnChL._AC_.jpg"); background-size:300px;}
      
      #image-2 {background-image: url("https://m.media-amazon.com/images/I/518jlKqZrUL._AC_SL1000_.jpg"); background-size: 250px;}
      
      #image-3 {background-image: url("https://www.alsahaba.com.eg/wp-content/uploads/2022/01/images5.jpg?d3f359&d3f359"); background-size: 250px;}
      
      #image-4 {background-image: url("https://m.media-amazon.com/images/I/71mzCXW2j8L._AC_SL1500_.jpg"); background-size: 250px;}
    ...
    <div class="listing-section">
        ...
        <div class="product">
          ...
          ?>
            ...
            <?php
          $quantity_query='select quantity from product where product_id=1';
          $result=mysqli_query($conn,$quantity_query);
          $avaliable_quant=mysqli_fetch_assoc($result);
          if($avaliable_quant['quantity']>0){
            echo '<a href="lenovolaptop.php"><button type="button" name="item-1-view"   id="item-1-view">View</button></a> ';
          }else{
            echo '<a href="lenovolaptop.php"><button disabled type="button" name="item-1-view"   id="item-1-view">Out of stock</button></a> ';
          }
          ?>
          </div>
        </div>
        ...
        <div class="product">
          ...
          <div class="text-box">
            <h2 class="item">Lenovo Legion 5 Pro Laptop</h2> 
            <h3 class="price">33,999 EGP</h3> 
        ...
        <div class="product">
          ...
          <div class="text-box">
            <h2 class="item">ALIENWARE M15 GAMING LAPTOP</h2>
            <h3 class="price">22,999 EGP</h3>
        ...
        <div class="product">
          ...
          <div class="text-box">
            <h2 class="item">Hp Gaming Pavilion </h2>
            <h3 class="price">22,500 EGP</h3>
